...
var editor_add = CKEDITOR.replace('post-content-add');
var editor_edit = CKEDITOR.replace('post-content-edit');
var editor_portfolio_add = CKEDITOR.replace('add');
var editor_portfolio_edit = CKEDITOR.replace('edit');
